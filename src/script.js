...
roof.position.y = WallHeight + 0.5 // half the cone height
...
const bushMetarial = new THREE.MeshStandardMaterial({ color: '#89c854' })
 ...
 * Ghost
 */
const ghost1 = new THREE.PointLight('#f4232f', 2, 3)
scene.add(ghost1)
...
const tick = () => {
    ...
    ghost3.position.x = Math.cos(ghost3Angle) * (7 + Math.sin(elapsedTime * .5))
